        ...
        <CCardBody>
          <table class="table-layout">
            ...
            <tr class="table-tr">
              ...
              <td class="table-td">
                <CInput size="lg" v-model="value_host" required :invalid-feedback="flag_hostPass"
              ...
              <td class="table-td">
                <CInput size="lg" v-model="value_port" required :invalid-feedback="flag_portPass"
            ...
            <tr class="table-tr">
              <td class="table-td">
                <CInput size="lg" v-model="value_sender" required :invalid-feedback="flag_senderPass"
                  :is-valid="senderValidator" />
              </td>
              <td class="table-td">
                <CInput size="lg" v-model="value_account" required :invalid-feedback="flag_accountPass"
                  :is-valid="accountValidator" />
              </td>
              <td class="table-td">
                <CInput size="lg" v-model="value_password" required :type="flag_view_password ? 'text' : 'password'"
                  :invalid-feedback="$t('noEmptyNoSpaceOnly')" :is-valid="passwordValidator">
              ...
              <td class="table-td">
                <CInput size="lg" v-model="value_subject" required :invalid-feedback="$t('noEmptyNoSpaceOnly')"
            ...
            <tr class="table-tr">
              <td class="table-td">
                <!-- <multiselect
                  ...
                  @input="ccListOnInput"
                /> -->
                <CInput size="lg" v-model="value_to" required :invalid-feedback="flag_toPass"
              ...
              <td class="table-td">
                <!-- <multiselect
                  ...
                  :options="param_personGroupList"
                /> -->
                <CInput size="lg" v-model="value_cc" required :invalid-feedback="flag_ccPass" :is-valid="ccValidator" />
              </td>
              <td class="table-td">
                <!-- <multiselect
                  placeholder=""
                  ...
                  :options="param_personGroupList"
                /> -->
                <CInput size="lg" v-model="value_bcc" required :invalid-feedback="value_bcc" :is-valid="bccValidator" />
              </td>

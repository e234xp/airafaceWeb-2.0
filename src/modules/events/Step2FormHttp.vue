      ...
      <CCardBody>
        <table class="table-layout">
          ...
          <tr class="table-tr">
            ...
            <td class="table-td">
              <CSwitch size="lg" class="mb-form-row" color="success" shape="pill" :checked="form.https"
            ...
            <td class="table-td">
              <form>
                <CInput class="mb-form-row" size="lg" placeholder="" autocomplete="on"
                  :type="flag_view_password ? 'text' : 'password'" v-model="form.pass">
          ...
          <tr class="table-tr">
            ...
            <td class="table-td">
              <CInput id="pathInput" type="text" size="lg" style="display: inline-block; width: 85%" prepend="/"
                v-model="value_realTime_eventHttpUrl" @input="handlePathInput" />
            </td>
          ...
          <CCol sm="12">
            <CRow>
              <CCol sm="12">
                ...
                <CSelect size="lg" :filterable="true" :value.sync="form.method" :options="value_eventHttpMethodList"
                  @change="clearSetting" />
              </CCol>
                ...
                <CForm style="position: relative; display: block; padding-bottom: 10px">
                  <CRow>
                    <CCol sm="3">
                      ...
                      <CInput size="lg" placeholder="" required style="display: block; margin-bottom: 0px"
                    ...
                    <CCol sm="4">
                      ...
                      <div style="position: relative; display: block; height: 40px">
                        <CSelect id="defaultList" size="lg" style="
                              position: relative;
                              display: block;
                              margin-bottom: 0px;
                              z-index: 10000;
                            " :filterable="true" :options="value_defaultDataList"
                          :value.sync="value_selectedDefaultData" />
                      </div>
                    </CCol>

                    <CCol sm="1">
                      <CButton type="submit" variant="outline" size="lg" style="
                          position: relative;
                          ...
                          top: 1.85rem;
                          margin-bottom: 0px;
                        " :disabled="!isAddNewField" @click="addNewField">
                        +
                      </CButton>
                    </CCol>
                    ...
                    <CCol sm="2" style="flex: 0 0 14.666667%; max-width: 14.666667%">
                      ...
                      <CButtonGroup v-if="form.method === 'POST'" class="float-right mr-3" size="lg" style="
                            position: relative;
                            height: 45px;
                            float: none !important;
                            margin-bottom: 0px;
                          ">
                        <CButton style="color: #20a8d8; border: 1px solid #20a8d8" color="outline-secondary"
                          v-for="(value, key) in [0, 1]" :key="key"
                          :pressed="value === value_selectedData ? true : false" @click="selectDateType(value)">
                    ...
                    <CCol sm="12">
                      ...
                      <CTextarea id="customBody1" spellcheck="false" rows="10" placeholder=""
                        style="position: relative; width: 100%"
                        :is-valid="formPass.body = checkBody(value_customTextarea) === ''"
                        :invalid-feedback="checkBody(value_customTextarea)" :value="value_customTextarea"

<template>
  <div>
    ...
    <stepprogress class="w-step-progress-4" icon-class="fa fa-check" :active-thickness="param_activeThickness"
      ...
      <CCard :class="showOnStep(0)" :style="param_cardStyle">
        <CCardBody>
          <table class="table-layout">
            ...
            <tr class="table-tr">
              <td class="table-td">
                <CInput size="lg" v-model="value_actionruleName" required :invalid-feedback="disp_noEmptyNorSpaceOnly"
        ...
        <CCardBody>
          <table class="table-layout">
            ...
            <tr class="table-tr">
              ...
              <td class="table-td">
                <multiselect :class="flag_personGroupPass ? 'is-valid' : 'is-invalid'" placeholder="" :multiple="true"
                  :hide-selected="true" :searchable="false" :select-label="disp_select" :selected-label="disp_selected"
                  :deselect-label="disp_deselect" v-model="value_selectedPersonGroupList"
                  :options="param_personGroupList" @input="personGroupListOnInput"
                  :disabled="value_accessType=='Unidentified'" />
                <div v-if="!flag_personGroupPass" class="invalid-feedback">
                  {{ disp_noEmptyNorSpaceOnly }}
                </div>
              </td>
              <td class="table-td">
                <multiselect :class="flag_videoGroupPass ? 'is-valid' : 'is-invalid'" placeholder="" :multiple="true"
                  :hide-selected="true" :searchable="false" :select-label="disp_select" :selected-label="disp_selected"
                  :deselect-label="disp_deselect" v-model="value_selectedVideoGroupList" :options="param_vedioGroupList"
                  @input="videoGroupListOnInput" />
                <div v-if="!flag_videoGroupPass" class="invalid-feedback">
                  {{ disp_noEmptyNorSpaceOnly }}
                </div>
              </td>
              <td class="table-td">
                <CSelect size="lg" :value.sync="value_timeRange" :options="param_timeRangeListValue" required
                  :invalid-feedback="disp_noEmptyNorSpaceOnly" :is-valid="timeRangeValidator" />
              </td>
            </tr>
          </table>
        </CCardBody>
          ...
          <table class="table-layout">
            ...
            <tr class="table-tr">
              <td class="table-td">
                <multiselect placeholder="" :multiple="true" :hide-selected="true" :searchable="false"
                  ...
                  v-model="value_selectedIoBoxList" :options="param_ioBoxList" />
              </td>
              <td class="table-td">
                <multiselect placeholder="" :multiple="true" :hide-selected="true" :searchable="false"
                  :select-label="disp_select" :selected-label="disp_selected" :deselect-label="disp_deselect"
                  v-model="value_selectedWiegandList" :options="param_wiegandList" />
              </td>
              <td class="table-td" />
              <td class="table-td" />
            </tr>
            ...
            <tr class="table-tr">
              <td class="table-td">
                <multiselect placeholder="" :multiple="true" :hide-selected="true" :searchable="false"
                  :select-label="disp_select" :selected-label="disp_selected" :deselect-label="disp_deselect"
                  v-model="value_selectedLineNotifyList" :options="param_lineNotifyList" />
              </td>
              <td class="table-td">
                <multiselect placeholder="" :multiple="true" :hide-selected="true" :searchable="false"
                  :select-label="disp_select" :selected-label="disp_selected" :deselect-label="disp_deselect"
                  v-model="value_selectedMailNotifyList" :options="param_mailNotifyList" />
              </td>
              <td class="table-td">
                <multiselect placeholder="" :multiple="true" :hide-selected="true" :searchable="false"
                  :select-label="disp_select" :selected-label="disp_selected" :deselect-label="disp_deselect"
                  v-model="value_selectedHttpNotifyList" :options="param_httpNotifyList" />
              </td>
              <td class="table-td" />
            </tr>
          </table>
    ...
    <CCol sm="12">
      ...
      <div class="row justify-content-center mb-4">
        ...
        <div>
          <CButton class="btn btn-primary fz-lg btn-w-normal" @click="clickOnNext" :disabled="
              flag_currentSetp == 0 ?

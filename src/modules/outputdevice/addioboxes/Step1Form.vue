      ...
      <CCardBody v-show="flag_basicBrandVisiable">
        <CRow sm="12">
          <CCol sm="6" class="h5">
            ...
            <CSelect size="lg" v-model="localStep1form.brand" :options="value_brandList" :filterable="true"
          ...
          <CCol sm="6" class="h5">
            ...
            <CSelect size="lg" v-model="localStep1form.model" :options="value_modelList" :filterable="true"
              class="font-control mt-2" />
          </CCol>
        </CRow>
        ...
        <CRow sm="12">
          ...
          <CCol sm="6" class="h5 d-none">
            ...
            <multiselect class="mt-2" v-model="localStep1form.divice_groups" placeholder=""
              :options="value_deviceGroupsList" :multiple="true" :taggable="true" :hide-selected="true"
      ...
      <CCardBody v-show="flag_connectionVisiable">
        <CRow sm="12">
          <CCol sm="6" class="h5">
            ...
            <CInput size="lg" class="mt-2" v-model="localStep1form.ip_address" :invalid-feedback="flag_ipAddrPass"
              :is-valid="ipAddrValidator" required />
          </CCol>
          <CCol sm="6" class="h5">
            <h5 class="ml-2">
              {{ disp_IOBoxesBasicPort }}
            </h5>
            <CInput size="lg" class="mt-2" v-model.number="localStep1form.port" :invalid-feedback="flag_portPass"
              :is-valid="portValidator" required />
          </CCol>
        </CRow>
        <CRow sm="12">
          <CCol sm="6" class="h5">
            ...
            <CInput size="lg" class="mt-2" v-model="localStep1form.username" :invalid-feedback="$t('NoEmptyNoSpace')"
              :is-valid="isFieldPassed('user', localStep1form.username)" required />
          </CCol>
          <CCol sm="6" class="h5">
            <h5 class="ml-2">
              {{ disp_IOBoxesBasicPassword }}
            </h5>
            <CInput size="lg" class="mt-2" v-model="localStep1form.password"
              :type="flag_view_password ? 'text' : 'password'" :invalid-feedback="$t('NoEmptyNoSpace')"
              :is-valid="isFieldPassed('pass', localStep1form.password)" required>

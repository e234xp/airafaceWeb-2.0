  ...
  <div>
    <CCol sm="12">
      ...
      <stepprogress class="w-step-progress-2" :active-thickness="param_activeThickness"
        ...
        :passive-color="param_passiveColor" :steps="[$t('AccountInfo'), $t('Complete')]"
            ...
            <tr>
              ...
              <td class="table-td">
                <CInput class="mb-form-row" size="lg" :type="flag_view_password ? 'text' : 'password'"
                  :invalid-feedback="$t('NoEmptyNoSpace')" value="" v-model="value_password" placeholder=""
              ...
              <td class="table-td">
                <CInput class="mb-form-row" size="lg" :type="flag_view_password ? 'text' : 'password'"
                  :invalid-feedback="$t('PasswordIsDifferent')" value="" v-model="value_passwordConfirm" placeholder=""

      ...
      <CCol sm="12">
        <CRow>
          <div class="mb-3 d-flex align-items-center">
            <date-picker style="width: 500px" :lang="this.$globalDatePickerLanguage"
              v-model="value_specifiedDatetimeRange" type="datetime" range :placeholder="$t('SelectDatetimeRange')"

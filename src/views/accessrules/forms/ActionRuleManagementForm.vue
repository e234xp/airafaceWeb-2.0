        ...
        <div>
          <div id="LineNotifyManagementFrom">
            ...
            >
              ...
              <vxe-table-column field="condition" width="20%" :show-overflow="ellipsisMode" :title="disp_what" type="html">
                <template #default="{ row }">
                  {{ row.condition.access_type }} <br> {{ formatVideoDeviceGroup(row.condition.video_device_groups) }}
                </template>
              </vxe-table-column>
              <vxe-table-column field="condition" width="20%" :show-overflow="ellipsisMode" :title="disp_who" type="html">
                <template #default="{ row }">
                  {{ formatPersonGroup(row.condition.groups) }}
                </template>
              </vxe-table-column>
              <vxe-table-column field="actions" width="20%" :show-overflow="ellipsisMode" :title="disp_when" type="html">
                <template #default="{ row }">

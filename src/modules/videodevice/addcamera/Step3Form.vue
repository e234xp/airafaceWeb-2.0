<template>
  <div id="wrapper">
    ...
    <div class="mt-3">
      ...
      <CRow sm="6" class="h5 ml-2 mb-3" style="padding-top: 10px; text-align: right">
        {{ disp_targetScore }}
      </CRow>
      <CRow>
        <CCol sm="6">
      ...
      <CRow>
        <CCol sm="6">
          <CSelect size="lg" v-model="localStep3form.antispoofing_score" :options="param_antiSpoofingOptions" />
        </CCol>
      </CRow>
      ...
      <CRow>
        <CCol sm="6">
          <CSelect size="lg" v-model="localStep3form.face_detection_score" :options="param_faceDetectionScore" />
        </CCol>
      </CRow>
      ...
      <CRow>
        <CCol sm="6">
          <CSelect size="lg" v-model="localStep3form.april_tag_type" :options="param_aprilTagType" />
        </CCol>
      </CRow>
    </div>
  </div>

    ...
    <CRow>
            ...
            <CCardBody>
              <CRow>
                ...
                <CCol sm="9">
                  <img
                    id="backgroundImage"
                    :src="value_capacitySetting.background_image"
            ...
            <CCardBody>
              <CRow>
                ...
                <CCol sm="9">
                  <img
                    id="logoImage"
                    :src="value_capacitySetting.logo"
                    style="
                      margin: auto;
                      height: 80px;
                      object-fit: contain;
            ...
            <CCardBody>
              <CRow>
                <CCol sm="12">
                  ...
                  <multiselect
                    v-model="value_capacitySetting.displayGroup"
                    placeholder=""
              ...
              <CRow>
                ...
                <CCol sm="3">
                  ...
                  <CSelect
                    size="lg"
                    :value.sync="value_capacitySetting.displayPhoto"
                ...
                <CCol sm="3">
                  ...
                  <CSelect
                    size="lg"
                    :value.sync="value_capacitySetting.line2"
                ...
                <CCol sm="3">
                  ...
                  <CSelect
                    size="lg"
                    :value.sync="value_capacitySetting.line1"
            ...
            <CCardBody>
              <CRow>
                <CCol sm="3">
                  ...
                  <CSelect
                    size="lg"
                    :value.sync="value_capacitySetting.pageLayout"
                ...
                <CCol sm="3">
                  ...
                  <CSelect
                    size="lg"
                    :value.sync="value_capacitySetting.dailyResetTime"
                ...
                <CCol sm="3">
                  ...
                  <CSelect
                    size="lg"
                    :value.sync="value_capacitySetting.personPatrolTime"
      ...
      >
        <table
          width="590"
          height="332"
          :style="`background-image: url('${value_capacitySetting.background_image}')`"
        ...
        >
          ...
          <tr>
            <td
              ...
              valign="top"
              height="50"
              v-show="value_capacitySetting.displayChart == true"
            >

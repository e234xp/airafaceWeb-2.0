        ...
        <CCol sm="12">
          <CRow>
            ...
            <div class="d-flex" style="margin-left: auto">
              <CInput style="width: 280px" size="lg" :placeholder="$t('Search')" v-model.lazy="value_searchingFilter"
        ...
        <div>
          <div id="EventControlManagement">
            <vxe-table stripe ref="mainTable" align="center" :data="value_dataItemsToShow" :cell-style="cellStyle"
              ...
              @checkbox-change="checkboxChange" @checkbox-all="selectAllCheckboxChange">

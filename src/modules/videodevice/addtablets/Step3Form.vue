<template>
  <div id="wrapper">
    ...
    <div class="mt-3">
      <!-- Enrollment info -->
      <CRow sm="12" class="h5 ml-2 mb-3" style="padding-top: 10px;text-align: right; ">{{ disp_serverAddress }}</CRow>
      <CRow>
        <CCol sm="6">
      ...
      <CRow sm="12" class="h5 ml-2 mb-3" style="padding-top: 10px;text-align: right; ">{{ disp_deviceId }}</CRow>
      <CRow>
        <CCol sm="6">
          <CInput size="lg"  class="h5"  style="width: 100%;" />
        </CCol>
...
export default {
  ...
  data() {
    return {
      ...
      disp_headertitle: i18n.formatter.format("TabletsBasicTitleNameEnrollmentInfo"),

      /*Card access title  */
      disp_cardAccessTitle: i18n.formatter.format("TabletsBasicTitleNameCardAccess"),

      /**content */
      disp_serverAddress: i18n.formatter.format("TabletsBasicCOlNameServerAddress"),

        ...
        <tr class="table-tr">
          ...
          <td class="table-td">
            <multiselect
              ...
              :show-no-options="false"
              @input="
                deviceGroupsValidator($event), handleUpdateEmitData('diviceGroups', handleParseDeviceGroup($event))
              "
            />
...
export default {
  ...
  data() {
    return {
      ...
      diviceGroupOptions: this.$route.params.value_diviceGroupOptions
        ? this.$route.params.value_diviceGroupOptions
        : [],
  ...
  computed: {
    ...
    parseEventControlDiviceGroups() {
      return this.eventControlDiviceGroups.map((id) => {
        const devGroup = this.diviceGroupOptions.find((item) => item.id === id);

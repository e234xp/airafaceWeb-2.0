      ...
      <CRow sm="12">
        ...
        >
          ...
          <CInput
            ...
            :is-valid="isFieldPassed('face_min_length', localStep3form.face_min_length)"
            required
            placeholder=""
          />
        </CCol>
      ...
      <CRow>
        <CCol sm="6">
          <CInput
            ...
            :is-valid="isFieldPassed('target_score', localStep3form.target_score)"
            required
            placeholder=""
          />
        </CCol>
      ...
      <CRow>
        <CCol sm="6">
          <CInput
            ...
            :is-valid="isFieldPassed('capture_interval', localStep3form.capture_interval)"
            required
            placeholder=""
          />
        </CCol>
        ...
        <CCol sm="6">
          ...
          >
            <el-slider
              ...
              style="flex: 1"
            />
            <span class="ml-3 h5 mb-0">{{ localStep3form.face_detection_score ? localStep3form.face_detection_score.toFixed(1) : '0.3' }}</span>
          </div>
        </CCol>
      </CRow>

            ...
            <tbody>
              ...
              <tr>
                <td class="fz-lg w-50 px-4 pt-1 pb-3 align-top">
                  <multiselect placeholder="" :multiple="true" :hide-selected="true" :taggable="true"
                    :show-no-options="false" :select-label="$t('Select')" :selected-label="$t('Selected')"
                    :deselect-label="$t('Deselect')" v-model="default_attendance_setting.video_device_group_in"
                ...
                <td class="fz-lg w-50 px-4 pt-1 pb-3 align-top">
                  <multiselect placeholder="" :multiple="true" :hide-selected="true" :taggable="true"
                    :show-no-options="false" :select-label="$t('Select')" :selected-label="$t('Selected')"
                    :deselect-label="$t('Deselect')" v-model="default_attendance_setting.video_device_group_out"

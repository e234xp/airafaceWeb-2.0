      ...
      <CCardBody v-show="flag_faceAccessVisiable">
        <CRow sm="12">
          <CCol sm="6" class="h5">
            ...
            <CInput size="lg" class="h5" v-model.number="localStep2form.verify_target_score"
        ...
        <CRow sm="12">
          <CCol sm="6" class="h5">
            ...
            <CInput size="lg" class="h5" v-model.number="localStep2form.face_capture_interval"
        ...
        <CRow sm="12">
          <CCol sm="6" class="h5">
            ...
            <CInput size="lg" class="h5" v-model.number="localStep2form.face_overlap_ratio"
              :invalid-feedback="disp_noEmptyInRange0to1"
        ...
        <CRow sm="12">
          <CCol sm="6" class="h5">
            ...
            <CInput size="lg" class="h5" v-model.number="localStep2form.target_face_size_width"
      ...
      <CCardBody v-show="flag_cardAccessVisiable">
        ...
        <CRow sm="12">
          <CCol sm="6" class="h5">
            ...
            <multiselect placeholder="" :multiple="true" :hide-selected="true" :searchable="false"
        ...
        <CRow sm="12">
          ...
          <CCol sm="6" class="h5">
            ...
            <CInput size="lg" class="mt-2" v-model.number="localStep2form.relay_delay"
      ...
      <CCardBody v-show="flag_temperatureMaskVisiable">
        ...
        <CRow sm="12">
          <CCol sm="6" class="h5">
            ...
            <CInput size="lg" class="mt-2" v-model.number="localStep2form.high_temperature"
      ...
      <CCardBody v-show="flag_rtspSettingVisiable">
        ...
        <CRow sm="12">
          <CCol sm="6" class="h5">
            ...
            <CInput size="lg" class="mt-2" readonly v-model="localStep2form.ip_address" />
          </CCol>
        </CRow>
        ...
        <CRow sm="12">
          <CCol sm="6" class="h5">
            ...
            <CInput size="lg" class="mt-2" v-model="localStep2form.rtsp_username"
              :invalid-feedback="$t('NoEmptyNoSpace')" :is-valid="checkRtspUsername"
              :required="localStep2form.enable_rtsp_camera" :disabled="!localStep2form.enable_rtsp_camera" />
          </CCol>
        </CRow>
        ...
        <CRow sm="12">
          <CCol sm="6" class="h5">
            ...
            <CInput size="lg" class="mt-2" :type="flag_view_password ? 'text' : 'password'"
              :disabled="!localStep2form.enable_rtsp_camera" v-model="localStep2form.rtsp_password">

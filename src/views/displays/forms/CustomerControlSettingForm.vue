<template>
  <div>
    <CRow>
      <CCol sm="12">
        <div class="h1 mb-5">
          {{ $t('PageTitleCustomerBoardSettings') }}
        </div>
        <stepprogress
    ...
    <CRow>
            ...
            <CCardBody>
              <CRow>
                ...
                <CCol sm="9">
                  <img
                    id="backgroundImage"
                    :src="value_customersetting.background_image"
            ...
            <CCardBody>
              <CRow>
                ...
                <CCol sm="9">
                  <img
                    id="logoImage"
                    :src="value_customersetting.logo"
                    style="
                      margin: auto;
                      height: 80px;
                      object-fit: contain;
            ...
            <CCardBody>
              <!-- <CRow>
                <CCol sm="12">
                  ...
                  <multiselect
                    v-model="value_customersetting.displayGroup"
                    placeholder=""
              ...
              <CRow>
                <CCol sm="3">
                  ...
                  <CSelect
                    size="lg"
                    :value.sync="value_customersetting.displayPhoto"
                ...
                <!-- <CCol sm="3">
                  ...
                  <CSelect
                    size="lg"
                    :value.sync="value_customersetting.line1"
            ...
            <CCardBody>
              <CRow>
                ...
                <CCol sm="3">
                  ...
                  <CSelect
                    size="lg"
                    :value.sync="value_customersetting.dailyResetTime"
      ...
      >
        <table
          width="590"
          height="332"
          :style="`background-image: url('${value_customersetting.background_image}')`"
        ...
        >
          <tr>
            <td height="46">
              <img
                :src="`${value_customersetting.logo}`"
                style="width:60px; border-radius: 100%; padding-left: 15px;"
              >
          ...
          <tr>
            <td
              ...
              valign="top"
              height="50"
              v-show="value_customersetting.displayChart == true"
            >
          ...
          <tr>
            ...
            >
              <img
                v-show="(
                  value_customersetting.pageLayout=='LARGE' &&
                  value_customersetting.displayCardMode=='STANDARD' &&
                  value_customersetting.displayChart
                )
                "
              ...
              <img
                v-show="(
                  value_customersetting.pageLayout=='SMALL' &&
                  value_customersetting.displayCardMode=='STANDARD' &&
                  value_customersetting.displayChart
                )
                "
...
import { airalogo } from '@/utils/capacityMode';
  ...
  methods: {
    ...
    onBackgroundUploadFiles() {
      ...
      myReader.onloadend = async () => {
        this.value_customersetting.background_image = myReader.result;
      };
    ...
    onLogoUploadFiles() {
      ...
      const myReader = new FileReader();
      myReader.onloadend = async () => {
        this.value_customersetting.logo = myReader.result;
      };
      myReader.readAsDataURL(file);
    },
      ...
      if (this.flag_currentSetp == 0) {
        ...
        if (this.onFinish) {
          ...
          const sendData = {
            ...
            pageLayout: this.value_customersetting.pageLayout,
            // displayChart: this.value_customersetting.displayChart,
            displayChart: false,
            dailyResetTime: this.value_customersetting.dailyResetTime,
            personPatrolTime: this.value_customersetting.personPatrolTime,

            // enableSummaryView: this.value_customersetting.enableSummaryView,
            // summaryBy: this.value_customersetting.summaryBy,
            // summaryPatrolTime: this.value_customersetting.summaryPatrolTime,
            // patrolidleTime: this.value_customersetting.patrolidleTime
          };

          this.value_Setting.CUSTOMER = sendData;

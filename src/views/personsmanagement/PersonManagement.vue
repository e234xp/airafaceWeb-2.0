...
export default {
  ...
  data() {
    return {
      ...
      value_emptyPhoto:
        'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAERlWElmTU0AKg' +
  ...
  methods: {
    ...
    async onModify(allPerson, pItem) {
      ...
      item.register_image =
        photoRet.data && photoRet.data.register_image.length > 0 ? photoRet.data.register_image : '';

...
export default {
  ...
  methods: {
    ...
    clickOnDatDetails(item, dayIdx) {
      ...
      //   this.value_specifiedMonth.getFullYear(),
      //   this.value_specifiedMonth.getMonth(),
      //   1,
      //   0, 0, 0, 0,
      // );
      ...
      if (item.attendance_data_list && item.attendance_data_list.length > 0) {
        const l = [];
        if (Object.keys(item.attendanceStatusData.attendance_data.clock_in_record[dayIdx]).length > 0) {
          l.push(item.attendanceStatusData.attendance_data.clock_in_record[dayIdx]);
        }
        if (Object.keys(item.attendanceStatusData.attendance_data.clock_out_record[dayIdx]).length > 0) {
          l.push(item.attendanceStatusData.attendance_data.clock_out_record[dayIdx]);
        }

      ...
      <CCol sm="12">
        <CRow class="justify-content-between">
          <div class="d-flex align-items-center h-100 mb-3 mr-3">
            ...
            ></date-picker>
            <CButton
              class="btn btn-secondary btn-icon p-0 ml-2"
              @click="clickOnSearch()"
            ...
            <CDropdown
              :togglerText="toggleText()"
              class="btn btn-primary dropdown-export ml-3 p-0 dropdown-theme"
              size="lg"
              :disabled="!flag_enableSearchButton"
            >
              <CDropdownItem @click="exportExcel(true)"
                >{{ disp_exportExcel }} ({{ disp_withPhoto }})</CDropdownItem
              >

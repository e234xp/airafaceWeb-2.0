        ...
        <CCardBody>
          <div>
            <vxe-table :data="value_dataItemsToShow" height="531" columns-height="100" stripe align="center"
              ...
              <vxe-table-column field="dateTime" :title="disp_dateTime" width="30%" style="font: 10px" align="center">
              </vxe-table-column>
              <vxe-table-column field="log_level" :title="disp_logLevel" width="30%" align="center"></vxe-table-column>
              <vxe-table-column field="data" :title="disp_info" width="40%" align="left"></vxe-table-column>
            </vxe-table>
          </div>
          <vxe-pager :layouts="[
              'PrevJump',

...
Vue.prototype.$globalFindPersonWithoutPhoto = (uuid, shift, sliceSize, keyword, cb, uuidList = null) =>
  new Promise((resolve) => {
    const query = {
      uuid,
      slice_shift: shift,
...
Vue.prototype.$globalGetAttendanceSummary = (startTime, endTime, cb) =>
  new Promise((resolve) => {
    const query = {
      start_time: startTime,
      end_time: endTime,

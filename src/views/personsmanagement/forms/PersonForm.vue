<template>
  <div>
    ...
    <stepprogress class="w-step-progress-3" :active-thickness="param_activeThickness"
      ...
      :steps="[$t('InputPersonInfo'), $t('SelectRegisterPhoto'), $t('Complete')]" :current-step="flag_currentSetp"
            ...
            <tr class="table-tr">
              <td class="table-td">
                <CInput :disabled="modifyMode || !canModify()" size="lg"
                  :invalid-feedback="$t('MoreThan4lettersAndNumbers')" value="" v-model="value_personId" placeholder=""
                  :is-valid="personIdValidator" required />
              </td>
              <td class="table-td">
                <CInput :disabled="!canModify()" size="lg" :invalid-feedback="$t('NoEmptyNoSpaceOnly')" value=""
            ...
            <tr class="table-tr">
              <td class="table-td">
                <CInput class="input-no-spin" :disabled="!canModify()" size="lg" v-model="value_cardNumber"
                  placeholder="" :invalid-feedback="$t('NoRepeat')"
            ...
            <CRow class="mb-4">
              <CCol sm="6">
                ...
                <multiselect v-model="value_selectedGroupList" placeholder="" :options="value_allGroupsList"
                  :multiple="true" :hide-selected="true" :select-label="$t('Select')" :selected-label="$t('Selected')"
                  :deselect-label="$t('Deselect')" :searchable="false" />
              </CCol>
                ...
                <CCol sm="12" class="mb-2">
                  <div class="row justify-content-center">
                    <CButton class="btn-outline-primary fz-lg mx-1" style="width: 40%"
                      :disabled="flag_isPickingDisplayPhoto" @click="clickOnPickDisplayPhoto">
                      {{ $t('SelectPhoto') }}
                    </CButton>

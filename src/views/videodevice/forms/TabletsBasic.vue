  ...
  <div id="wrapper">
    ...
    <CCard>
      <CCardBody>
        ...
        <CRow sm="12" class="h5 ml-2 mb-3" style="padding-top: 10px;text-align: right; ">
          {{ $t('TabletsBasicCOlNameDeviceName') }}
        </CRow>
        <CRow>
          <CCol sm="6">
            <CInput size="lg" class="h5" style="width: 100%;" />
        ...
        <div>
          <h2 sm="12">
            {{ $t('TabletsBasicTitleNameFaceAccess') }}
          </h2>
        </div>
        ...
        <CRow sm="12" class="h5 ml-2 mb-3" style="padding-top: 10px;text-align: right; ">
          {{ $t('TabletsBasicCOlNameRecognitionThreshold') }}
        </CRow>
        <CRow>
          <CCol sm="12">
            <CInput size="lg" class="h5" style="width: 100%;" />
        ...
        <!-- Card access -->
        <CRow sm="12" class="h5 ml-2 mb-3" style="padding-top: 10px;text-align: right; ">
          {{ $t('TabletsBasicTitleNameCardAccess') }}
        </CRow>
        <CRow>
          <CCol sm="6">
            <v-select v-model="value_deviceGroups" :options="value_deviceGroupsList" :filterable="true"
              class="font-control" />
          </CCol>
        </CRow>

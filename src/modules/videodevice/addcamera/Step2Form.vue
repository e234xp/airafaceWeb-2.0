<template>
  <div id="wrapper">
    ...
    <!-- +-ROI -->
    <CRow sm="12" class="h5 ml-2 mb-3" v-if="!flag_snapshotReadly">
    ...
    <CRow sm="12" class="h5 ml-2" style="text-align: center;">
      ...
      <CCol sm="2">
        ...
        padding-left: 10px; padding-right: 10px; margin-right: 6px; display: inline-block; line-height: 28px;">1</span>
        <CButton class="btn btn-primary btn-roi mr-1" size="sm" @click="addROI(0)">
          {{ disp_addROI }} 1
        </CButton>
        <CButton class="btn btn-primary btn-roi" size="sm" @click="removeROI(0)">
          {{ disp_removeROI }} 1
        </CButton>
      </CCol>
      <CCol sm="2">
        <span style="background-color: #FFC93E;
        padding-left: 10px; padding-right: 10px; margin-right: 6px; display: inline-block; line-height: 28px;">2</span>
        <CButton class="btn btn-primary btn-roi mr-1" size="sm" @click="addROI(1)">
          {{ disp_addROI }} 2
        </CButton>
        <CButton class="btn btn-primary btn-roi" size="sm" @click="removeROI(1)">
          {{ disp_removeROI }} 2
        </CButton>
      </CCol>
      <CCol sm="2">
        <span style="background-color: #DC79FF;
        padding-left: 10px; padding-right: 10px; margin-right: 6px; display: inline-block; line-height: 28px;">3</span>
        <CButton class="btn btn-primary btn-roi mr-3" size="sm" @click="addROI(2)">
          {{ disp_addROI }} 3
        </CButton>
        <CButton class="btn btn-primary btn-roi" size="sm" @click="removeROI(2)">
          {{ disp_removeROI }} 3
        </CButton>
      </CCol>
      <CCol sm="2">
        <span style="background-color: #90D678;
        padding-left: 10px; padding-right: 10px; margin-right: 6px; display: inline-block; line-height: 28px;">4</span>
        <CButton class="btn btn-primary btn-roi mr-3" size="sm" @click="addROI(3)">
          {{ disp_addROI }} 4
        </CButton>
        <CButton class="btn btn-primary btn-roi" size="sm" @click="removeROI(3)">
          {{ disp_removeROI }} 4
        </CButton>
      </CCol>
      <CCol sm="2">
        <span style="background-color: #7DD2FF;
        padding-left: 10px; padding-right: 10px; margin-right: 6px; display: inline-block; line-height: 28px;">5</span>
        <CButton class="btn btn-primary btn-roi mr-3" size="sm" @click="addROI(4)">
          {{ disp_addROI }} 5
        </CButton>
        <CButton class="btn btn-primary btn-roi" size="sm" @click="removeROI(4)">
          {{ disp_removeROI }} 5
        </CButton>
      </CCol>
      <CCol sm="1" />

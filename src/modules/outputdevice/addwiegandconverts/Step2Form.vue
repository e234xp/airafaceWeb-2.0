    ...
    <div class="mt-3">
      <CRow sm="6">
        <CCol sm="6" class="h5">
          ...
          <CSelect
            size="lg"
            v-model.number="localStep2form.bits"
      ...
      <CRow sm="12">
        <CCol sm="6" class="h5">
          ...
          <CInput
            size="lg"
            class="mt-2"
            v-model.number="localStep2form.index"
            :invalid-feedback="$t('NoEmptyNoSpace')"
            :is-valid="isFieldPassed('index', localStep2form.index)"
            required
          />
        </CCol>
        ...
        <CCol sm="6" class="h5">
          ...
          <CInput
            size="lg"
            class="mt-2"
            v-model.number="localStep2form.syscode"
            :invalid-feedback="$t('NoEmptyNoSpace')"
            :is-valid="isFieldPassed('syscode', localStep2form.syscode)"
            required
          />
        </CCol>
      </CRow>
      ...
      <CRow sm="12" class="pt-3">
        <CCol sm="6" class="h5">
          ...
          <CInput
            size="lg"
            class="mt-2"
            v-model="localStep2form.special_card_number"
            />
        </CCol>
      </CRow>

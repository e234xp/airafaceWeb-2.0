                  ...
                  <CCol col="12" class="text-left">
                    ...
                    <CRow>
                      <CCol col="12" class="text-center">
                        <CButton style="width: 140px; color: #20a8d8; border: 1px solid #20a8d8"
                          :disabled="value_username === '' || value_password === ''" @click="clickOnLogin">
                          {{ disp_title }}
                        </CButton>
                      </CCol>
                      <CCol col="6" class="text-right" style="padding-top: 8px;" />
                    </CRow>
                    <div class="forget-password" @click="onForget">
                      {{ $t('ForgotPassword') }}?
                    </div>
                  </CCol>
                </CRow>

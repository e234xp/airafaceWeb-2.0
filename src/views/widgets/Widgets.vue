<template>
  <div>
      ...
      <CCol sm="6" lg="3">
        <CWidgetProgress footer="Lorem ipsum dolor sit amet enim.">
          ...
          <div class="card-header-actions">
            <a href="https://coreui.io/vue/docs/components/widgets" class="card-header-action position-absolute"
              style="right:5px; top:5px" rel="noreferrer noopener" target="_blank">
              <small class="text-muted">docs</small>
            </a>
          </div>
          <div>Lorem ipsum...</div>
          <CProgress color="gradient-success" :value="25" class="progress-xs my-3 mb-0" />
        </CWidgetProgress>
      </CCol>
      <CCol sm="6" lg="3">
        <CWidgetProgress header="12.124" text="Lorem ipsum..." footer="Lorem ipsum dolor sit amet enim."
          color="gradient-info" :value="25" />
      </CCol>
      <CCol sm="6" lg="3">
        <CWidgetProgress header="$98.111,00" text="Lorem ipsum..." footer="Lorem ipsum dolor sit amet enim."
          color="gradient-warning" :value="25" />
      </CCol>
      <CCol sm="6" lg="3">
        <CWidgetProgress header="2 TB" text="Lorem ipsum..." footer="Lorem ipsum dolor sit amet enim."
          color="gradient-danger" :value="25" />
      </CCol>
    </CRow>
    <CRow>
      <CCol sm="6" lg="3">
        <CWidgetProgress header="89.9%" text="Lorem ipsum..." footer="Lorem ipsum dolor sit amet enim."
          color="gradient-success" inverse :value="25" />
      </CCol>
      <CCol sm="6" lg="3">
        <CWidgetProgress header="12.124" text="Lorem ipsum..." footer="Lorem ipsum dolor sit amet enim."
          color="gradient-info" inverse :value="25" />
      </CCol>
      <CCol sm="6" lg="3">
        <CWidgetProgress header="$98.111,00" text="Lorem ipsum..." footer="Lorem ipsum dolor sit amet enim."
          color="gradient-warning" inverse :value="25" />
      </CCol>
      <CCol sm="6" lg="3">
        <CWidgetProgress header="2 TB" text="Lorem ipsum..." footer="Lorem ipsum dolor sit amet enim."
          color="gradient-danger" inverse :value="25" />
      </CCol>
    </CRow>
    <CRow>
    ...
    <CRow>
      <CCol col="12" sm="6" lg="3">
        <CWidgetIcon header="$1.999,50" text="Income" color="gradient-primary" :icon-padding="false">
          <CIcon name="cil-settings" width="24" />
        </CWidgetIcon>
      </CCol>
      <CCol col="12" sm="6" lg="3">
        <CWidgetIcon header="$1.999,50" text="Income" color="gradient-info" :icon-padding="false">
          <CIcon name="cil-laptop" width="24" />
        </CWidgetIcon>
      </CCol>
      <CCol col="12" sm="6" lg="3">
        <CWidgetIcon header="$1.999,50" text="Income" color="gradient-warning" :icon-padding="false">
          <CIcon name="cil-moon" width="24" />
        </CWidgetIcon>
      </CCol>
      <CCol col="12" sm="6" lg="3">
        <CWidgetIcon header="$1.999,50" text="Income" color="gradient-danger" :icon-padding="false">
          <CIcon name="cil-bell" width="24" />
        </CWidgetIcon>
      </CCol>
    </CRow>
        ...
        <CWidgetIcon header="$1.999,50" text="Income" color="gradient-warning" :icon-padding="false">
          ...
          <template #footer>
            <CCardFooter class="px-3 py-2">
              <CLink class="font-weight-bold font-xs text-muted d-flex justify-content-between"
                href="https://coreui.io/" target="_blank">
                View more

    ...
    _children: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            permission: ['Admin', 'PowerUser', 'User'],
            name: i18n.formatter.format('PresenceDetail'),
            to: '/reports/presencedetail',
          },
        ],
      },
...

      {
        ...
        items: [
          {
            permission: ['Admin', 'PowerUser'],
            name: i18n.formatter.format('Welcome_Mode'),
...

      {
        ...
        items: [
          ...
          {
            permission: ['Admin'],
            name: i18n.formatter.format('Diagnose'),
            to: '/systemsettings/diagnose',
          },
        ],
      },
    ],

          ...
          <CRow class="justify-content-between buttons-group">
            ...
            <div class="d-flex">
              ...
              <date-picker :lang="this.$globalDatePickerLanguage" style="visibility: hidden; width: 0px" type="month"
                ref="datePicker" @change="datePickerDatachange()" v-model="value_monthPicked" />
        ...
        <div>
          <div id="monthlyAttendanceReportForm">
            <vxe-table :data="value_dataItemsToShow" stripe align="center" :cell-style="cellStyle"
              ...
              <vxe-table-column :show-overflow="ellipsisMode" field="person" :title="$t('Person')" width="10%"
                align="left" type="html" style="font: 10px" />
              <vxe-table-column :show-overflow="ellipsisMode" field="groups" :title="$t('Group')" align="left"
                type="html" width="10%" />
              <vxe-table-column :show-overflow="ellipsisMode" field="clockDate" :title="$t('Date')" width="10%" />
              <vxe-table-column :show-overflow="ellipsisMode" field="workingTimeToShow" :title="$t('WorkingTime')"
                align="left" type="html" width="15%" />
              <vxe-table-column :show-overflow="ellipsisMode" field="attendanceStatusText"
                :title="$t('MonthlyAttendanceStatus')" align="left" type="html" width="15%" />
              <vxe-table-column field="attendanceStatus" :title="$t('MonthlyAttendanceStatus')" min-width="400"
                type="html" />
          ...
          <ul class="list-group">
            ...
            <li class="list-group-item" v-for="(item, index) in value_masternotinExportList" :key="index">
              <input class="form-check-input me-1" type="checkbox" value="item"
                @change="fieldChanged('MASTER', item, $event)"> {{ value_masterfieldsforExport.find((field) => {return

    ...
    <CRow>
      <CCol sm="12">
        ...
        <stepprogress
          ...
          :steps="[$t('CompanyInfo'), $t('PersonInfo'), $t('Complete')]"
    ...
    <CRow>
              ...
              <CRow>
                ...
                <CCol sm="3">
                  ...
                  <CSelect
                    ...
                    :options="[{ value: 0, label: $t('Disable') }, 5, 10, 15, 20, 30, 60]"
                    :disabled="!value_occupancySetting.enableSummaryView"
                  />
                </CCol>
              </CRow>
      ...
      <CCol sm="6" v-show="flag_currentSetp == 0 || flag_currentSetp == 1">
        ...
        >
          <tr>
            <td height="46">
              <img :src="`${value_occupancySetting.logo}`" style="width: 40px; padding-left: 15px" />
              <span style="float: right; padding-right: 15px; color: #ffffff">12:32</span>
            </td>
          </tr>
          <tr>
            <td align="center" valign="top" height="40" v-show="value_occupancySetting.displayChart == true">
              ...
              >
                ...
                <div style="display: flex; gap: 6px">
                  <div
                    ...
                    "
                  >
                    <img src="/img/empty-face.svg" style="width: 30px; height: 30px; object-fit: contain" />
                    <div style="display: flex; flex-direction: column; justify-content: center; text-align: left">
                      <div style="font-weight: 500; font-size: 8px; color: white">資訊一</div>
                      <div style="color: white; font-weight: 700; font-size: 10px; line-height: 100%">姓名</div>
                    </div>
                  </div>
                </div>
                <!-- 第二行卡片 -->

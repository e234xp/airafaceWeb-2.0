<template>
  <div>
    ...
    <CRow>
      <CCol sm="6" v-show="flag_currentSetp==0||flag_currentSetp==1">
          ...
          <CCard>
            ...
            <CCardBody>
              <CRow>
                ...
                <CCol sm="9">
                  <img id="backgroundImage" :src="value_capacitySetting.background_image"
          ...
          <CCard>
            ...
            <CCardBody>
              <CRow>
                ...
                <CCol sm="9">
                  <img id="logoImage" :src="value_capacitySetting.logo" style="
                      margin: auto;
                      height: 80px;
                      object-fit: contain;
        ...
        <div :class="showOnStep(1)">
            ...
            <CCardBody>
              <CRow>
                <CCol sm="12">
                  ...
                  <multiselect v-model="value_capacitySetting.displayGroup" placeholder="" style="margin-bottom: 12px;"
              ...
              <CRow>
                <!-- <CCol sm="3">
                  <div class="h5">{{ disp_displayMode }}</div>
                  <CSelect size="lg" :value.sync="value_capacitySetting.displayCardMode"
                    :options="value_displayModeList" />
                </CCol> -->

                <CCol sm="3">
                  <div class="h5">{{ disp_displayPhoto }}</div>
                  <CSelect size="lg" :value.sync="value_capacitySetting.displayPhoto"
                    :options="value_displayPhotoList" />
                </CCol>
                <CCol sm="3">
                  <div class="h5">{{ disp_LineAttribute }} 1</div>
                  <CSelect size="lg" :value.sync="value_capacitySetting.line2" :options="value_displayPrimaryList" />
                </CCol>
                <CCol sm="3">
                  <div class="h5">{{ disp_LineAttribute }} 2</div>
                  <CSelect size="lg" :value.sync="value_capacitySetting.line1" :options="value_displayAttributeList"
                    :disabled="value_capacitySetting.displayCardMode == 'COMPACT'" />
                </CCol>
                <CCol sm="3"></CCol>
              </CRow>
            </CCardBody>
          ...
          <CCard>
            ...
            <CCardBody>
              <CRow>
                <CCol sm="3">
                  <div class="h5">{{ disp_pagelayout }}</div>
                  <CSelect size="lg" :value.sync="value_capacitySetting.pageLayout" :options="value_pageLayoutList" />
                </CCol>
                <!-- <CCol sm="3">
                  <div class="h5">{{ disp_displayChart }}</div>
                  <CSelect size="lg" :value.sync="value_capacitySetting.displayChart" :options="value_EnableList" />
                </CCol> -->
                <CCol sm="3">
                  <div class="h5">{{ disp_dailyResetTime }}</div>
                  <CSelect size="lg" :value.sync="value_capacitySetting.dailyResetTime"
                    :options="value_displayResetTime" />
                </CCol>
                <CCol sm="3">
                  <div class="h5">{{ disp_personPatrolTime }}</div>
                  <CSelect size="lg" :value.sync="value_capacitySetting.personPatrolTime" :options="[5,10,15,20,30]" />
                </CCol>
                <CCol sm="3"></CCol>
              </CRow>
            </CCardBody>
      ...
      <CCol sm="6" v-show="flag_currentSetp==0||flag_currentSetp==1">
        <table width="590" height="332" :style="`background-image: url('${value_capacitySetting.background_image}')`"
          style="background-size: 100% 100%; background-repeat: no-repeat; background-position: center;">
          <tr>
            <td height="46">
              <img :src="`${value_capacitySetting.logo}`" style="width:60px; height:25px; padding-left: 15px;" />
...
" />
          ...
          <tr>
            <td align="center" height="100%">
              <img v-show="(
                  value_capacitySetting.pageLayout=='LARGE' &&
                  value_capacitySetting.displayCardMode=='STANDARD' &&
                  value_capacitySetting.displayChart
                )
                " src="@/assets/img/24c.png" />
              <img v-show="(
                value_capacitySetting.pageLayout=='SMALL' &&
                value_capacitySetting.displayCardMode=='STANDARD' &&
                value_capacitySetting.displayChart
              )
              " src="@/assets/img/8c.png" />
      ...
      <CCol sm="12" v-show="flag_currentSetp==2">
...
<script>
  ...
  const defaultlState = () => {
    return {
      ...
      disp_header: i18n.formatter.format("PageTitleOccupancyBoardSettings"),
      ...
      disp_displayMode: i18n.formatter.format("DisplayMode"), //
      ...
      disp_pagelayout: i18n.formatter.format("PageLayout"), //
      disp_displayChart: i18n.formatter.format("DisplayChart"), //
      disp_dailyResetTime: i18n.formatter.format("ResetTime"), //
      disp_personPatrolTime: i18n.formatter.format("Duration"), //

      disp_SummaryDisplay: i18n.formatter.format("SummaryDisplay"), //
      disp_SummaryView: i18n.formatter.format("SummaryView"), //
      disp_summaryBy: i18n.formatter.format("SummaryBy"), //
      disp_summaryPatrolTime: i18n.formatter.format("Duration"), //
      disp_patrolidleTime: i18n.formatter.format("IdleTime"), //
      ...
      value_EnableList: [
        { value: true, label: i18n.formatter.format("Enable") },
        { value: false, label: i18n.formatter.format("Disable") }
      ],

      // value_summaryByList: [
      //   { value: "GROUP", label: i18n.formatter.format("Group") },
      ...
      //   { value: "STANDARD", label: i18n.formatter.format("Standard") },
      //   { value: "COMPACT", label: i18n.formatter.format("Compact") }
      // ],
      ...
      value_pageLayoutList: [
        { value: "LARGE", label: i18n.formatter.format("LARGE") },
        { value: "SMALL", label: i18n.formatter.format("SMALL") },
      ],

      value_displayGroupList: [],

      value_Setting: {},
      value_capacitySetting: {
      ...
      // value_displayOccupancySize: ["5 x 5", "6 x 6", "7 x 7", "8 x 8"],
  ...
  export default {
    ...
    async mounted() {
      ...
      self.$globalGetGroupList(function (err, data) {
        if (!err) {
      ...
      self.$globalGetDisplaySetting(function (err, data) {
        if (!err) {
          ...
          self.value_capacitySetting.uuid = self.makeid(32);

          self.value_capacitySetting = Object.assign({}, self.value_capacitySetting, self.occupancy);
        }
    ...
    methods: {
      ...
      onBackgroundUploadFiles(event) {
        ...
        myReader.onloadend = async (e) => {
          self.value_capacitySetting.background_image = myReader.result;
        };
      ...
      onLogoUploadFiles(event) {
        ...
        let myReader = new FileReader();
        myReader.onloadend = async (e) => {
          self.value_capacitySetting.logo = myReader.result;
        };
        myReader.readAsDataURL(file);
      },
      ...
      clickOnNext() {
        ...
        if (self.flag_currentSetp == 0) {
          ...
          if (self.onFinish) {
            ...
            let sendData = {
              displayMode: "CAPACITY",
              uuid: self.value_capacitySetting.uuid,
              background_image: self.value_capacitySetting.background_image,
              logo: self.value_capacitySetting.logo,

              displayGroup: self.value_capacitySetting.displayGroup,
              displayCardMode: "STANDARD",
              displayPhoto: self.value_capacitySetting.displayPhoto,
              line1: self.value_capacitySetting.line1,
              line2: self.value_capacitySetting.line2,

              pageLayout: self.value_capacitySetting.pageLayout,
              // displayChart: self.value_capacitySetting.displayChart,
              displayChart: false,
              dailyResetTime: self.value_capacitySetting.dailyResetTime,
              personPatrolTime: self.value_capacitySetting.personPatrolTime,

              // enableSummaryView: self.value_capacitySetting.enableSummaryView,
              // summaryBy: self.value_capacitySetting.summaryBy,
              // summaryPatrolTime: self.value_capacitySetting.summaryPatrolTime,
              // patrolidleTime: self.value_capacitySetting.patrolidleTime
            };

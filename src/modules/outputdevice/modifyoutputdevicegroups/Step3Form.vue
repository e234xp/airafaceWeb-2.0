...
<script>
  ...
  export default {
    ...
    return {
        ...
        value_dataItemsToShow: [{enable:false, name:'Wiegand Converters #1', group:'Clock-in'}, {enable:false, name:'Wiegand Converters #2', group:'Entrance'}],
        value_allTableItems: [],
        value_tablePage: {
          currentPage: 1,
          pageSize: 5,
        ...
        /*data table */
        disp_tabletDevices: i18n.formatter.format("Wiegandboxs"),

      ...
      <CCardBody class="py-5">
        <CCol sm="12">
          <CRow class="justify-content-center">
            <CButton class="btn btn-danger btn-w-md mr-4 my-2" @click="clickOnExcecute" :disabled="flag_applying">
              <div style="font-size: 20px">
                {{ $t('FactoryDefault') }}
              </div>
            </CButton>
            <CButton class="btn btn-primary btn-w-md mx-4 my-2" @click="clickOnReboot" :disabled="flag_applying">
              <div style="font-size: 20px">
                {{ $t('Reboot') }}
              </div>
            </CButton>
            <CButton class="btn btn-primary btn-w-md mx-4 my-2" @click="clickOnRestart" :disabled="flag_applying">
              <div style="font-size: 20px">
                {{ $t('RestartService') }}
              </div>
            </CButton>

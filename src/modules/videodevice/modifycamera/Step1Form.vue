        ...
        <CRow sm="12">
          <CCol sm="6" class="h5">
            ...
            <CInput size="lg" class="mt-2" style="width: 100%" v-model="localStep1form.ip_address"
              :invalid-feedback="flag_ipAddrPass" :is-valid="ipAddrValidator" required />
          </CCol>

          <CCol sm="6" class="h5">
            {{ disp_port }}
            <CInput size="lg" class="mt-2" style="width: 100%" v-model.number="localStep1form.port"
              :invalid-feedback="flag_portPass" :is-valid="portValidator" required />
          </CCol>
        </CRow>
      </div>
        ...
        <CRow sm="12">
          <CCol sm="6" class="h5">
            ...
            <CInput size="lg" class="mt-2" style="width: 100%" v-model="localStep1form.user"
              :invalid-feedback="flag_userPass" :is-valid="userValidator" required />
          </CCol>

          <CCol sm="6" class="h5">
            {{ disp_password }}
            <CInput size="lg" :type="flag_view_password ? 'text' : 'password'" class="mt-2" style="width: 100%"
              v-model="localStep1form.pass" required>

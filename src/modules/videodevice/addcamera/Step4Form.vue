    ...
    <div class="mt-3">
      <CRow sm="12">
        <CCol sm="6" class="h5">
          ...
          <CSelect size="lg" v-model="localStep4form.verified_merge_setting.enable" :placeholder="disp_placeholder"
      ...
      <CRow sm="12">
        <CCol sm="6" class="h5">
          ...
          /> -->
          <CInput size="lg" v-model.number="localStep4form.verified_merge_setting.merge_duration"
      ...
      <CRow sm="12" class="mt-3">
        <CCol sm="6" class="h5">
          <h5 class="ml-2">
            {{ $t('EnableNonVerifiedMerge') }}
          </h5>
          <CSelect size="lg" v-model="localStep4form.non_verified_merge_setting.enable" :placeholder="disp_placeholder"
            :options="param_enableOptions" />
        </CCol>
      </CRow>
      <CRow sm="12">
        <CCol sm="6" class="h5">
          ...
          <CSelect size="lg" v-model="localStep4form.non_verified_merge_setting.merge_duration"
            :placeholder="disp_placeholder" :options="param_durationOptions"
      ...
      <CRow sm="12">
        <CCol sm="6" class="h5">
          ...
          <CInput size="lg" v-model.number="localStep4form.non_verified_merge_setting.merge_score"

              ...
              <CCol sm="12">
                ...
                <div class="w-100 d-flex flex-column align-items-center"
                  ...
                  <vue-qr v-if="value_verifiedImageUseDynamicQrCode_disp"
                    :text="value_verifiedImageQrcodeString_converted" class="w-75 mb-3" />
                  ...
                  <div v-if="value_verifiedImageUseDynamicQrCode_disp">
                    <textarea class="form-control mb-3" rows="10" :value="value_dynamicParamsFormat" readonly />
                  </div>
                </div>
              </CCol>
            </CCol>
            ...
            <CCol sm="3">
              <CCol sm="12">
                <CCol sm="12">
                  ...
                  <CInput size="lg" v-model="value_verifiedTopMessage_disp" :placeholder="$t('DefaultValue')" />
                </CCol>
                <CCol sm="12">
                  <div class="h5">
                    {{ $t('BottomMessage') }}
                  </div>
                  <CInput size="lg" v-model="value_verifiedBottomMessage_disp" :placeholder="$t('DefaultValue')" />
                </CCol>
                <CCol sm="12">
                  <div class="h5">
                    {{ $t('TextColor') }}
                ...
                <CCol sm="12">
                  ...
                  <textarea v-if="value_verifiedImageUseDynamicQrCode_disp" class="form-control"
                    style="font-size: 14px; resize: none" rows="7" v-model="value_verifiedImageQrcodeString_disp" />
                </CCol>
              </CCol>
            </CCol>
              ...
              <CCol sm="12">
                ...
                <div class="w-100 d-flex flex-column align-items-center"
                  ...
                  <vue-qr v-if="value_unverifiedImageUseDynamicQrCode_disp"
                    :text="value_unverifiedImageQrcodeString_converted" class="w-75 mb-3" />
            ...
            <CCol sm="3">
              <CCol sm="12">
                <CCol sm="12">
                  ...
                  <CInput size="lg" v-model="value_unverifiedTopMessage_disp" :placeholder="$t('DefaultValue')" />
                </CCol>
                <CCol sm="12">
                  <div class="h5">
                    {{ $t('BottomMessage') }}
                  </div>
                  <CInput size="lg" v-model="value_unverifiedBottomMessage_disp" :placeholder="$t('DefaultValue')" />
                </CCol>
                <CCol sm="12">
                  <div class="h5">
                    {{ $t('TextColor') }}
                ...
                <CCol sm="12">
                  ...
                  <textarea v-if="value_unverifiedImageUseDynamicQrCode_disp" class="form-control"
                    style="font-size: 14px; resize: none" rows="7" v-model="value_unverifiedImageQrcodeString_disp" />
                </CCol>
              </CCol>
            </CCol>
          </CRow>
            ...
            <CRow>
              <CCol sm="3">
                <div class="column-space-between">
                  ...
                  <CInput size="lg" :invalid-feedback="$t('NoEmptyNoSpaceOnly')" value=""
            ...
            <CRow>
              ...
              <CCol sm="6">
                ...
                <textarea class="form-control" style="resize: none; font-size: 20px" rows="9"
                  :value="value_resposeFormat" readonly />
              </CCol>
            </CRow>
          </CCol>
        </CCardBody>
...
sms ex : SMSTO:0988123456:{{personName}} is clockin
    ...
    methods: {
      ...
      urlValidator() {
        const processStr = `https://127.0.0.1${this.value_httpUrl_disp.length > 0 && this.value_httpUrl_disp[0] != '/'
            ? '/'
            : ''
          }${this.value_httpUrl_disp}`;

  ...
  <div class="ratio-wrap ratio-wrap-16x9">
    <div class="ratio-content selfcheckin-dashboard">
      <img :src="display.logo"
        ...
        :style="{ left: `${(paddingX / 2) + 16}px` }" @click="toLoginPage" v-if="display.logo !== ''">
      ...
      <template v-if="currentStep === 1">
        <div class="section-step-1" :style="{ zoom: `${zoomRatio}!important` }">
          ...
          <button class="switch-camera-btn" @click="switchCamera">{{ $t('SwitchCamera') }}</button>
          <QrcodeStream @decode="onDecode" :camera="selectedCamera" class="qrcodeReader" v-if="freshReader" />
      ...
      <template v-if="currentStep === 2">
        <div class="section-step-2" :style="{ width: `calc(100% - ${paddingX}px)`, zoom: `${zoomRatio}!important` }">
          <div class="info">
            <div>
              <div>{{ $t('VisitorId') }}</div>
              <div>{{ visitor.id }}</div>
          ...
          <div class="webcam-list">
            <div class="btn type-1" @click="onReTake">
              {{ $t('ReTake') }}
            </div>
            <div class="webcam" style="margin-right: 2rem;">
            ...
            <div class="webcam" style="margin-left: 2rem; margin-top: 3.2rem">
              <img :src="imageList[0]" class="mirror" style="width: 100%; height: 100%;"
                v-show="imageList[0] && imageList[0] !== ''">
            </div>
            <div class="btn type-2" @click="onRegister(0)">
              {{ $t('Capture') }}
            </div>
          </div>
        </div>
      ...
      <template v-if="currentStep === 3">
        <div class="section-step-3" :style="{ zoom: `${zoomRatio}!important` }">
          <div class="image">
            <img class="mirror" :src="selectedImage" style="width: 100%; height: 100%; object-fit: contain;"
              v-if="selectedImage !== ''">
          </div>
          <div class="info">
            <div>
      ...
      <div class="house-icon" @click="onBack" :style="{ right: `${(paddingX / 2) + 16}px` }" v-if="currentStep === 2">

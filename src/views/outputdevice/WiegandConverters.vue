<template>
  <div>
    <CRow>
      <CCol sm="12">
        <WiegandConvertersForm :formData="$data" :onAdd="onAdd" :onDelete="onDelete" :onModify="onModify" :onFetchDataCallback="onFetchDataCallback"/>
      </CCol>
    </CRow>
  </div>
</template>
...
<script>
  import WiegandConvertersForm from './forms/WiegandConvertersForm.vue'
  ...
  export default {
    ...
    components: { WiegandConvertersForm },
    data() {
      return {

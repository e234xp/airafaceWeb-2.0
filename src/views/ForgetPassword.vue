            ...
            <CCardBody>
              <CForm>
                ...
                <CRow>
                  ...
                  >
                    <CButton
                      style="color: #20a8d8; border: 1px solid #20a8d8; width: 100%"
                      @click="onBack"
                    >
                      {{ $t('GoBack') }}
                    </CButton>
                  ...
                  >
                    <CButton
                      style="width: 100%; color: #20a8d8; border: 1px solid #20a8d8"
                      :disabled="flag_reset_finish"
                      @click="onReset"
                    >
                      {{ $t('Reset') }}
                    </CButton>
